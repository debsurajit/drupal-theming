...
<div class="header_wrapper">
    ...
    <div class="banner-text animatedParent">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 banner-text">
                    <?php print render($page['banner_text']); ?>
                    <a href="" class="banner-button animated bounceInUp findMe">Read More</a>
                </div>
            </div>
        </div>
...
<div class="advantage">
    <div class="container">
        <div class="row animatedParent">
            <?php print render($page['advantage']); ?>
        </div>
    </div>
</div>
...
<div class="client-talk">
    ...
    <div class="container">
        <div class="row animatedParent">
            <?php print render($page['client_say']); ?>
        </div>
    </div>
...
<div class="contact-us clearfix">
    <div class="col-sm-6 map">
        <img src="<?php print drupal_get_path('theme', 'own_theme') . '/images/contact.jpg'; ?>" alt="<?php print $site_name_and_slogan ?>" />
    </div>
    <div class="col-sm-6">
        <h2>Contact</h2>
        <?php print render($page['home_contact']); ?></div>          
</div>
